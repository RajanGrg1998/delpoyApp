...
import 'package:clip_app/controller/lastclip_controller.dart';
import 'package:clip_app/utils/constant.dart';
...
import '../main.dart';
import 'editorpage/ios_editclips_page.dart';

class FinalRecordingPage extends StatefulWidget {
  const FinalRecordingPage({Key? key}) : super(key: key);

  @override
  State<FinalRecordingPage> createState() => _FinalRecordingPageState();
}

class _FinalRecordingPageState extends State<FinalRecordingPage>
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomTimeButton(
                          ...
                          onPressed: () async {
                            if (isRecordingInProgress) {
                              clipCon.changeIsLandscapeRecordingClickedValue(
                                  false);
                              clipCon
                                  .changeIsPotraitRecordingClickedValue(false);
                              ...
                              clipCon
                                  .changeIsPotraitRecordingClickedValue(true);
